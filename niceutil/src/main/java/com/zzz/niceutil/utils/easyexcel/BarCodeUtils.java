...
public class BarCodeUtils {
     ...
     * 默认图片宽度
     */
    private static final int DEFAULT_PICTURE_WIDTH = 100;
     ...
     * 默认条形码宽度
     */
    private static final int DEFAULT_BAR_CODE_WIDTH = 80;

    /**
     * 默认条形码高度
     */
    private static final int DEFAULT_BAR_CODE_HEIGHT = 50;
